...
gseGO_glm = readRDS("results/gsea_GO/gseGO_glm.rds")
...
saveRDS(tissue_gse_devil, "results/tissue_specific/tissue_gse_devil.rds")
saveRDS(tissue_gse_glm, "results/tissue_specific/tissue_gse_glm.rds")
saveRDS(tissue_gse_nebula, "results/tissue_specific/tissue_gse_nebula.rds")
...
# Plot UMAPS
umap_glm_private = readRDS("results/special_genes/glmGamPoi private.RDS")
umap_glm_and_devil = readRDS("results/special_genes/glmGamPoi and devil.RDS")
